...
import org.vulcanium.util.StringUtil;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;
import org.vulcanium.command.defaults.*;
...
public class SimpleCommandMap implements CommandMap {
    ...
    private void setDefaultCommands() {
        register("vulcanium", new VersionCommand("version"));
        register("vulcanium", new ReloadCommand("reload"));
        register("vulcanium", new PluginsCommand("plugins"));
        register("vulcanium", new TimingsCommand("timings"));
    }

    public void setFallbackCommands() {
        register("vulcanium", new HelpCommand());
    }
    ...
    private synchronized boolean register(@NotNull String label, @NotNull Command command, boolean isAlias, @NotNull String fallbackPrefix) {
        ...
        if ((command instanceof VulcaniumCommand || isAlias) && knownCommands.containsKey(label)) {

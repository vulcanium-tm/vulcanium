 ...
 * VulcaniumObjectInputStream}.
 * <p>
 * Behavior of implementations extending this class is not guaranteed across
 * future versions.
 */
public class VulcaniumObjectOutputStream extends ObjectOutputStream {
     ...
     */
    protected VulcaniumObjectOutputStream() throws IOException, SecurityException {
        super();
     ...
     */
    public VulcaniumObjectOutputStream(OutputStream out) throws IOException {
        super(out);
        enableReplaceObject(true);
    }

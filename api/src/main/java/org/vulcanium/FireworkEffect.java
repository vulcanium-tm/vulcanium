...
public final class FireworkEffect implements ConfigurationSerializable {
    ...
    public static final class Builder {
         ...
         */
        @NotNull
        public FireworkEffect.Builder with(@NotNull FireworkEffect.Type type) throws IllegalArgumentException {
         ...
         */
        @NotNull
        public FireworkEffect.Builder withColor(@NotNull Color color) throws IllegalArgumentException {
         ...
         */
        @NotNull
        public FireworkEffect.Builder withColor(@NotNull Color... colors) throws IllegalArgumentException {
         ...
         */
        @NotNull
        public FireworkEffect.Builder withColor(@NotNull Iterable<?> colors) throws IllegalArgumentException {
            Preconditions.checkArgument(colors != null, "Cannot have null colors");
         ...
         */
        @NotNull
        public FireworkEffect.Builder withFade(@NotNull Color color) throws IllegalArgumentException {
            Preconditions.checkArgument(color != null, "Cannot have null color");
         ...
         */
        @NotNull
        public FireworkEffect.Builder withFade(@NotNull Color... colors) throws IllegalArgumentException {
            Preconditions.checkArgument(colors != null, "Cannot have null colors");
            if (colors.length == 0) {
                return this;
            }
         ...
         */
        @NotNull
        public FireworkEffect.Builder withFade(@NotNull Iterable<?> colors) throws IllegalArgumentException {
            Preconditions.checkArgument(colors != null, "Cannot have null colors");
    ...
    FireworkEffect(boolean flicker, boolean trail, @NotNull ImmutableList<Color> colors, @NotNull ImmutableList<Color> fadeColors, @NotNull FireworkEffect.Type type) {
        if (colors.isEmpty()) {

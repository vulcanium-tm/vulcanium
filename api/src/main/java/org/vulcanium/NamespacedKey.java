...
public final class NamespacedKey {
    ...
    /**
     * The namespace representing all keys generated by Vulcanium for backwards
    ...
    /**
     * Return a new random key in the {@link #VULCANIUM} namespace.
     *
     * @return new key
    ...
    public static NamespacedKey randomKey() {
        return new NamespacedKey(VULCANIUM, UUID.randomUUID().toString());
    }

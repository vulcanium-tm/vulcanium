...
import org.vulcanium.FireworkEffect.Type;
...
public class ObjectStreamTest {
    ...
    public void checkSerlialization(String className, String preEncoded, List<ConfigurationSerializable> object) throws Throwable {
        ...
        try {
            oos = new VulcaniumObjectOutputStream(out);
        ...
        try {
            ...
            ois = new VulcaniumObjectInputStream(in);
            preois = new VulcaniumObjectInputStream(preIn);

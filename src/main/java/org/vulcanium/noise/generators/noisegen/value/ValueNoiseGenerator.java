package org.vulcanium.noise.generators.noisegen.value;
...
import static org.vulcanium.noise.core.util.HashUtil.W_PRIME;
import static org.vulcanium.noise.core.util.HashUtil.X_PRIME;
import static org.vulcanium.noise.core.util.HashUtil.Y_PRIME;
import static org.vulcanium.noise.core.util.HashUtil.Z_PRIME;
...
public final class ValueNoiseGenerator implements SeededNoiseGenerator {
    ...
    public ValueNoiseGenerator(long seed, Interpolation interpolation, FadeFunction fadeFunction) {
        this.seed = seed;

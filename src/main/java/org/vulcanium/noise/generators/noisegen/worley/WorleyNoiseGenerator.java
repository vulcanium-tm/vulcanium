package org.vulcanium.noise.generators.noisegen.worley;

import org.vulcanium.noise.core.api.functions.Combiner;
import org.vulcanium.noise.core.api.noisegen.SeededExplicitNoiseGenerator;
import org.vulcanium.noise.core.api.pipeline.NoiseSourceBuilder;
import org.vulcanium.noise.core.util.HashUtil;
import org.vulcanium.noise.core.util.vectors.Vector;
import org.vulcanium.noise.core.util.vectors.Vector1D;
...
import org.vulcanium.noise.generators.noise_parameters.distance_functions.DistanceFunctionType;
import org.vulcanium.noise.generators.noise_parameters.return_type_functions.ReturnDistanceFunction;
import org.vulcanium.noise.generators.noise_parameters.return_type_functions.ReturnDistanceFunctionType;
...
public final class WorleyNoiseGenerator implements SeededExplicitNoiseGenerator<WorleyNoiseResult<Vector>> {
    ...
    public WorleyNoiseGenerator(long seed, int depth, DistanceFunction distanceFunction, IntToLongFunction fpAmountFunction, ReturnDistanceFunction returnDistanceFunction, Combiner minFunction) {
        this.seed = seed;
        this.depth = depth;

package org.vulcanium.noise.generators.noise_parameters.distance_functions;

/**
 * Interesting distance function that will be a bit more expensive to compute (especially for large values of p)
 * Also to note: p = 1 is the same as {@link org.vulcanium.noise.generators.noise_parameters.distance_functions.DistanceFunctionType#MANHATTAN} and p = 2 is the same as {@link DistanceFunctionType#EUCLIDEAN_SQUARED}, so don't use this for p = 1 and p = 2!
 *
 * @author Articdive
 */

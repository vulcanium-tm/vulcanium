package org.vulcanium.noise.pipeline;

import org.vulcanium.noise.core.api.functions.Combiner;
import org.vulcanium.noise.core.api.functions.Interpolation;
import org.vulcanium.noise.core.api.modifiers.NoiseModifier;
import org.vulcanium.noise.core.api.noisegen.NoiseResult;
...
import org.vulcanium.noise.core.api.transformers.DetailedTransformer;
import org.vulcanium.noise.core.api.transformers.SimpleTransformer;
import org.vulcanium.noise.core.util.vectors.Vector;
import org.vulcanium.noise.core.util.vectors.Vector2D;
import org.vulcanium.noise.core.util.vectors.Vector3D;
import org.vulcanium.noise.core.util.vectors.Vector4D;
import org.vulcanium.noise.generators.noise_parameters.distance_functions.DistanceFunction;
import org.vulcanium.noise.generators.noise_parameters.fade_functions.FadeFunction;
import org.vulcanium.noise.generators.noise_parameters.simplex_variants.Simplex2DVariant;
import org.vulcanium.noise.generators.noise_parameters.simplex_variants.Simplex3DVariant;
import org.vulcanium.noise.generators.noise_parameters.simplex_variants.Simplex4DVariant;
import org.vulcanium.noise.generators.noisegen.constant.ConstantNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.opensimplex.FastSimplexNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.opensimplex.SuperSimplexNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.perlin.PerlinNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.random.gaussian.GaussianWhiteNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.random.white.WhiteNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.value.ValueNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.worley.WorleyNoiseGenerator;
import org.vulcanium.noise.generators.noisegen.worley.WorleyNoiseResult;
import org.vulcanium.noise.modifiers.absolute_value.AbsoluteValueModifier;
import org.vulcanium.noise.modifiers.clamp.ClampModifier;
import org.vulcanium.noise.modifiers.inverter.InvertModifier;
import org.vulcanium.noise.modules.combination.CombinationModule;
import org.vulcanium.noise.modules.octavation.OctavationModule;
import org.vulcanium.noise.modules.octavation.fractal_functions.FractalFunction;
import org.vulcanium.noise.transformers.scale.ScaleTransformer;
...
public class JNoise implements NoiseSource {
    ...
    public static final class JNoiseBuilder<T extends NoiseResult> implements NoiseSourceBuilder {
        ...
        public org.vulcanium.noise.pipeline.JNoiseDetailed<T> buildDetailed() {
            if (source == null) {
                throw new IllegalArgumentException("Source must be defined.");
            }

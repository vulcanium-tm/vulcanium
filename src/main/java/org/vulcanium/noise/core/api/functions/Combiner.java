package org.vulcanium.noise.core.api.functions;

import org.vulcanium.noise.core.util.MathUtil;
...
public interface Combiner {
    ...
    Combiner EXPONENTIAL_SMOOTH_MIN = (a, b) -> {
        double res = org.vulcanium.noise.core.util.MathUtil.exp2(-32.0 * a) + org.vulcanium.noise.core.util.MathUtil.exp2(-32.0 * b);

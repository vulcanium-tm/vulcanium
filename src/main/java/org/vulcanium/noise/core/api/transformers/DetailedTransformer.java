package org.vulcanium.noise.core.api.transformers;
...
public interface DetailedTransformer {
     ...
     * @return {@link org.vulcanium.noise.core.util.vectors.Vector2D} containing the transformed x and y coordinates.
     */
     ...
     * @return {@link org.vulcanium.noise.core.util.vectors.Vector3D} containing the transformed x, y and z coordinates.
     */
     ...
     * @return {@link org.vulcanium.noise.core.util.vectors.Vector4D} containing the transformed x, y, z and w coordinates.
     */

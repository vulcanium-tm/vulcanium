...
public class BoundingBox implements Cloneable, ConfigurationSerializable {
     ...
     */
    @NotNull
    public static BoundingBox of(@NotNull org.vulcanium.util.Vector center, double x, double y, double z) {
    ...
    public BoundingBox resize(double x1, double y1, double z1, double x2, double y2, double z2) {
        org.vulcanium.util.NumberConversions.checkFinite(x1, "x1 not finite");
        org.vulcanium.util.NumberConversions.checkFinite(y1, "y1 not finite");
        org.vulcanium.util.NumberConversions.checkFinite(z1, "z1 not finite");
        org.vulcanium.util.NumberConversions.checkFinite(x2, "x2 not finite");
        org.vulcanium.util.NumberConversions.checkFinite(y2, "y2 not finite");
     ...
     */
    @NotNull
    public org.vulcanium.util.Vector getCenter() {
        return new org.vulcanium.util.Vector(this.getCenterX(), this.getCenterY(), this.getCenterZ());
    }
     ...
     */
    @NotNull
    public BoundingBox expand(@NotNull org.vulcanium.util.Vector expansion) {
     ...
     */
    @NotNull
    public BoundingBox expand(@NotNull org.vulcanium.util.Vector direction, double expansion) {
     ...
     */
    @NotNull
    public BoundingBox expandDirectional(@NotNull org.vulcanium.util.Vector direction) {
     ...
     *     bounding box
     */
    public boolean contains(@NotNull org.vulcanium.util.Vector min, @NotNull org.vulcanium.util.Vector max) {
        Preconditions.checkArgument(min != null, "Min is null!");
        Preconditions.checkArgument(max != null, "Max is null!");
        double x1 = min.getX();
        double y1 = min.getY();
     ...
     */
    @Nullable
    public org.vulcanium.util.RayTraceResult rayTrace(@NotNull org.vulcanium.util.Vector start, @NotNull org.vulcanium.util.Vector direction, double maxDistance) {
        ...
        // ray direction:
        org.vulcanium.util.Vector dir = direction.clone().normalizeZeros().normalize();

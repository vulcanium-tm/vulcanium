package org.vulcanium.util.noise.library.noise.generators.noisegen.perlin;
...
import org.vulcanium.util.noise.library.noise.core.util.vectors.Vector1D;
...
public final class PerlinNoiseGenerator implements SeededNoiseGenerator {
    ...
    public PerlinNoiseGenerator(long seed, Interpolation interpolation, FadeFunction fadeFunction) {
        this.seed = seed;

package org.vulcanium.util.noise.library.noise.modules.combination;

import org.jspecify.annotations.NullMarked;
import org.vulcanium.util.noise.library.noise.core.api.functions.Combiner;
import org.vulcanium.util.noise.library.noise.core.api.modules.NoiseModule;
...
@NullMarked
public record CombinationModule(NoiseSource a, NoiseSource b, Combiner combiner) implements NoiseModule {
    ...
    public static final class CombinationModuleBuilder implements NoiseSourceBuilder {
        public NoiseSource a;
        public NoiseSource b;
        public Combiner combiner = Combiner.ADD;

        public CombinationModuleBuilder() {
        }

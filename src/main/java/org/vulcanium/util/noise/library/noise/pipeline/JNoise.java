package org.vulcanium.util.noise.library.noise.pipeline;

import org.jspecify.annotations.NullMarked;
import org.vulcanium.util.noise.library.noise.core.api.functions.Combiner;
import org.vulcanium.util.noise.library.noise.core.api.functions.Interpolation;
...
import org.vulcanium.util.noise.library.noise.core.api.pipeline.NoiseSource;
import org.vulcanium.util.noise.library.noise.core.api.pipeline.NoiseSourceBuilder;
import org.vulcanium.util.noise.library.noise.core.api.transformers.DetailedTransformer;
...
import org.vulcanium.util.noise.library.noise.core.util.vectors.Vector2D;
import org.vulcanium.util.noise.library.noise.core.util.vectors.Vector3D;
import org.vulcanium.util.noise.library.noise.core.util.vectors.Vector4D;
import org.vulcanium.util.noise.library.noise.generators.noise_parameters.distance_functions.DistanceFunction;
import org.vulcanium.util.noise.library.noise.generators.noise_parameters.fade_functions.FadeFunction;
import org.vulcanium.util.noise.library.noise.generators.noise_parameters.simplex_variants.Simplex2DVariant;
import org.vulcanium.util.noise.library.noise.generators.noise_parameters.simplex_variants.Simplex3DVariant;
import org.vulcanium.util.noise.library.noise.generators.noise_parameters.simplex_variants.Simplex4DVariant;
import org.vulcanium.util.noise.library.noise.generators.noisegen.constant.ConstantNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.opensimplex.FastSimplexNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.opensimplex.SuperSimplexNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.perlin.PerlinNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.random.gaussian.GaussianWhiteNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.random.white.WhiteNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.value.ValueNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.worley.WorleyNoiseGenerator;
import org.vulcanium.util.noise.library.noise.generators.noisegen.worley.WorleyNoiseResult;
import org.vulcanium.util.noise.library.noise.modifiers.absolute_value.AbsoluteValueModifier;
import org.vulcanium.util.noise.library.noise.modifiers.clamp.ClampModifier;
import org.vulcanium.util.noise.library.noise.modifiers.inverter.InvertModifier;
import org.vulcanium.util.noise.library.noise.modules.combination.CombinationModule;
import org.vulcanium.util.noise.library.noise.modules.octavation.OctavationModule;
import org.vulcanium.util.noise.library.noise.modules.octavation.fractal_functions.FractalFunction;
import org.vulcanium.util.noise.library.noise.transformers.scale.ScaleTransformer;
...
public class JNoise implements NoiseSource {
    ...
    public static final class JNoiseBuilder<T extends NoiseResult> implements NoiseSourceBuilder {
        ...
        public JNoiseBuilder<?> value(long seed, FadeFunction fadeFunction) {
            return setNoiseSource(

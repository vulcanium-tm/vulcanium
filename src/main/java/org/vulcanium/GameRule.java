...
public final class GameRule<T> {
    ...
    private static GameRule<Boolean> createBooleanRule(String name) {
        return new GameRule<>(name, Boolean.class);
    }

    private static GameRule<Integer> createIntegerRule(String name) {
        return new GameRule<>(name, Integer.class);
    }

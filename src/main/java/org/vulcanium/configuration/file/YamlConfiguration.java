package org.vulcanium.configuration.file;

import com.google.common.base.Preconditions;
import org.vulcanium.Vulcanium;
import org.jetbrains.annotations.NotNull;
import org.vulcanium.configuration.Configuration;
import org.vulcanium.configuration.ConfigurationSection;
import org.vulcanium.configuration.InvalidConfigurationException;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public static YamlConfiguration loadConfiguration(@NotNull File file) {
        ...
        try {
            ...
            Vulcanium.getLogger().log(Level.SEVERE, "Cannot load " + file, ex);
    ...
    public static YamlConfiguration loadConfiguration(@NotNull Reader reader) {
        ...
        try {
            ...
            Vulcanium.getLogger().log(Level.SEVERE, "Cannot load configuration from stream", ex);
        } catch (InvalidConfigurationException ex) {
            Vulcanium.getLogger().log(Level.SEVERE, "Cannot load configuration from stream", ex);
        }

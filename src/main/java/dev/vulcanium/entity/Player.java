...
import dev.vulcanium.ban.IpBanList;
import dev.vulcanium.ban.ProfileBanList;
import dev.vulcanium.block.Block;
import dev.vulcanium.block.BlockState;
import dev.vulcanium.block.Sign;
import dev.vulcanium.block.TileState;
...
import dev.vulcanium.event.block.BlockBreakEvent;
import dev.vulcanium.event.block.BlockDropItemEvent;
import dev.vulcanium.event.player.PlayerExpCooldownChangeEvent;
import dev.vulcanium.event.player.PlayerResourcePackStatusEvent;
...
import dev.vulcanium.scoreboard.Scoreboard;
...
public interface Player extends HumanEntity, Conversable, OfflinePlayer, PluginMessageRecipient {
    ...
    @Deprecated
    void sendTitle(@NotNull Title var1);
    ...
    <T> @NotNull T getClientOption(@NotNull ClientOption<T> var1);
    /**

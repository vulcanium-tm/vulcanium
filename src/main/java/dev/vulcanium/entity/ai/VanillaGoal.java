...
import dev.vulcanium.annotation.GeneratedFrom;
import dev.vulcanium.namespaced.NamespacedKey;
import org.jetbrains.annotations.ApiStatus.ScheduledForRemoval;
import org.jetbrains.annotations.NotNull;
import dev.vulcanium.entity.RangedEntity;
import dev.vulcanium.entity.SchoolableFish;
...
public interface VanillaGoal<T extends Mob> extends Goal<T> {
    ...
    private static @NotNull GoalKey create(@NotNull String key, @NotNull Class clazz) {

...
import dev.vulcanium.boss.KeyedBossBar;
import dev.vulcanium.damage.DamageType;
import dev.vulcanium.enchantments.Enchantment;
import dev.vulcanium.entity.Cat;
import dev.vulcanium.entity.EntityType;
import dev.vulcanium.entity.Frog;
import dev.vulcanium.entity.Villager;
import dev.vulcanium.entity.memory.MemoryKey;
import dev.vulcanium.generator.structure.Structure;
import dev.vulcanium.generator.structure.StructureType;
import dev.vulcanium.inventory.meta.trim.TrimMaterial;
import dev.vulcanium.inventory.meta.trim.TrimPattern;
import dev.vulcanium.loot.LootTables;
...
import dev.vulcanium.world.Biome;
...
public interface Registry<T extends Keyed> extends Iterable<T> {
     ...
     * Server advancements.
     *
     * @see Vulcanium#getAdvancement(NamespacedKey)
     ...
     * Custom boss bars.
     *
     * @see Vulcanium#getBossBar(NamespacedKey)
     ...
     * Server structures.
     *
     * @see ConfiguredStructure
     */
    Registry<ConfiguredStructure> CONFIGURED_STRUCTURE = Vulcanium.getRegistry(ConfiguredStructure.class);
    /**
     * Server damage types.
     *
     * @see DamageType
    ...
    Registry<DamageType> DAMAGE_TYPE = (Registry)Objects.requireNonNull(Vulcanium.getRegistry(DamageType.class), "No registry present for DamageType. This is a bug.");
    /**
     * Server enchantments.
     *
     * @see Enchantment

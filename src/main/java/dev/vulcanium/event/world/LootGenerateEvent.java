...
import dev.vulcanium.event.entity.EntityDeathEvent;
import dev.vulcanium.inventory.InventoryHolder;
import dev.vulcanium.inventory.ItemStack;
import dev.vulcanium.loot.LootContext;
 ...
 * plugins invoking
 * {@link LootTable#fillInventory(org.vulcanium.inventory.Inventory, java.util.Random, LootContext)}.
 */

...
import dev.vulcanium.annotation.UndefinedNullability;
 ...
 * server info if {@link Vulcanium#getHideOnlinePlayers()} is true.
 */
public class ServerListPingEvent extends ServerEvent implements Iterable<Player> {
     ...
     * {@link Vulcanium#getHideOnlinePlayers()} is true.
     *
     * @throws UnsupportedOperationException if the caller of this event does

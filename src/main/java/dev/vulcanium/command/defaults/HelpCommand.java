...
import dev.vulcanium.help.HelpTopic;
import dev.vulcanium.help.HelpTopicComparator;
import dev.vulcanium.help.IndexHelpTopic;
import dev.vulcanium.util.ChatPaginator;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;
import dev.vulcanium.command.CommandSender;
import dev.vulcanium.command.ConsoleCommandSender;

public class HelpCommand extends VulcaniumCommand {
    public HelpCommand() {
        super("help");
        this.description = "Shows the help menu";
        this.usageMessage = "/help <pageNumber>\n/help <topic>\n/help <topic> <pageNumber>";
        this.setAliases(Arrays.asList(new String[]{"?"}));
        this.setPermission("vulcanium.command.help");
    }
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String currentAlias, @NotNull String[] args) {
        ...
        HelpMap helpMap = Vulcanium.getServer().getHelpMap();
    ...
    public List<String> tabComplete(@NotNull CommandSender sender, @NotNull String alias, @NotNull String[] args) {
        ...
        if (args.length == 1) {
            ...
            for (HelpTopic topic : Vulcanium.getServer().getHelpMap().getHelpTopics()) {

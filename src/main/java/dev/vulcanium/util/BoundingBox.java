...
public class BoundingBox implements Cloneable, ConfigurationSerializable {
     ...
     */
    @NotNull
    public static BoundingBox of(@NotNull dev.vulcanium.util.Vector center, double x, double y, double z) {
     ...
     */
    @NotNull
    public dev.vulcanium.util.Vector getCenter() {
        return new dev.vulcanium.util.Vector(this.getCenterX(), this.getCenterY(), this.getCenterZ());
    }

 ...
 * future versions.
 */
public class VulcaniumObjectInputStream extends ObjectInputStream {
     ...
     */
    protected VulcaniumObjectInputStream() throws IOException, SecurityException {
        super();
     ...
     */
    public VulcaniumObjectInputStream(InputStream in) throws IOException {
        super(in);
        super.enableResolveObject(true);
    }

...
import dev.vulcanium.block.data.*;
import dev.vulcanium.block.data.type.Bed;
import dev.vulcanium.block.data.type.Cake;
import dev.vulcanium.block.data.type.Chest;
import dev.vulcanium.block.data.type.Comparator;
import dev.vulcanium.block.data.type.Dispenser;
import dev.vulcanium.block.data.type.Door;
import dev.vulcanium.block.data.type.EnderChest;
import dev.vulcanium.block.data.type.Furnace;
import dev.vulcanium.block.data.type.Gate;
import dev.vulcanium.block.data.type.Hopper;
import dev.vulcanium.block.data.type.Ladder;
import dev.vulcanium.block.data.type.Leaves;
import dev.vulcanium.block.data.type.Observer;
import dev.vulcanium.block.data.type.RedstoneWire;
import dev.vulcanium.block.data.type.Sapling;
import dev.vulcanium.block.data.type.Sign;
import dev.vulcanium.block.data.type.Stairs;
import dev.vulcanium.block.data.type.TrapDoor;
import dev.vulcanium.block.data.type.Tripwire;
import dev.vulcanium.block.data.type.TripwireHook;
import dev.vulcanium.block.data.type.*;
